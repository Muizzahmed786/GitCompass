...
- Node/Edge graphing of services, modules, and dependencies using `@xyflow/react` and `dagre`.
- Interactive drill-downs: clicking a service reveals its file count, commit velocity, and history dynamically via `NodeInspector`.
